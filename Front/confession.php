...
<a href="#" class="profile" id="profile-link">
    <img src="<?php echo htmlspecialchars($profileImage); ?>" alt="Profile Icon">
        ...
        <h1 style="font-size:22px; font-family: sans-serif; opacity:.7;">Subject to Announcement</h1>
<a href="services.php" style="text-align:center; width:100px; padding:8px; background:#DB504A;
border-radius:5px; color:#fff;">Back</a>
</div>
        <div class="layout-page" style="disply:flex; justify-content:center; align-items:center;">
        ...
        padding:15px; border-radius:6px; cursor:default; font-family:san-serif;">
            <p style="text-align:center;">The Admin will post an Announcement for the Confession schedule. You can check the Announcement Board for further details.</p>
    ...
    <a href="announcement.php">Go to Announcement</a>
</form>
