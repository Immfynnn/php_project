...
<head>
    ...
    <title>Reservation | Burial</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        body {
            ...
            padding: 20px;
            min-height: 100vh;
            position: relative; /* Add this to position the loader correctly */
        }
    ...
    <div class="cont-burial">
        ...
        <form action="burial.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-b">
                ...
                <input type="text" id="ammount" name="ammount" value="<?php echo isset($amount) ? htmlspecialchars($amount) : 'PHP 1500.00'; ?>" readonly>
            </div>
            <div class="input-b">
