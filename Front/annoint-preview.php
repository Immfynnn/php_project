...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <div class="input-b">
        ...
        <input type="text" id="set_date" name="time_slot" value="<?php echo htmlspecialchars($reservation['time_slot']); ?>" readonly>
    </div>  
    <div class="input-b">
        <label for="s_address">Address:</label>
        <input type="text" id="set_date" name="s_address" value="<?php echo htmlspecialchars($reservation['s_address']); ?>" readonly>
    </div>  
...
<a href="edit-reservation-annoint.php?s_id=<?php echo $reservation['s_id']; ?>">Edit Reservation</a>
