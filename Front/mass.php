...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="mass-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
        <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Mass Intention'; ?>" name="service_type" style="display:none;">
    </div>


    <div class="input-b">
        <label for="r_type">Description:</label>
        <p style="font-size:13px; margin-top:10px;">Type of Mass Intention</p>
        <input type="text" id="r_type" name="r_type" placeholder="Misa Pasalamat, Misa sa Patay" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required placeholder="">
    </div>
    <div class="input-b">
        <label for="s_description1">Name:</label>
        <input type="text" id="s_description1" name="s_description1" placeholder="Full Name" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required placeholder="">
    </div>
    
    <div class="input-b">
    <label for="s_description">Schedule:</label>
        <select name="s_description" id="s_description">
