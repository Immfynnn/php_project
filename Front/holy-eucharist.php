...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="holy-eucharist-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
        <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Holy Eucharist'; ?>" name="service_type" style="display:none;">
    </div>

    <div class="input-b">
        <label for="s_description">Description:</label>
        <input type="text" id="s_description" name="s_description" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required placeholder="Mass in School And Mass in Church">
    </div>
    <div class="input-b">
        <label for="s_description1">No. of attendences:</label>
        <input type="number" id="s_description1" name="s_description1" value="<?php echo isset($description1) ? htmlspecialchars($description1) : ''; ?>" required placeholder="" style="width:100%;">
    </div>
    ...
    <input type="number" id="ammount" name="amount" value="" placeholder="Any Amount" oninput="showPaymentType()" style="width:100%;">
</div>
...
<div id="payment_type_container"></div>
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="content-detail-serv1" style="background:url('css/img/Holy_Eucharist.jpeg'); background-size:cover;">
        <div class="bg-content-bapt">  
          <h1 style="font-size:40px; text-transform:uppercase; font-weight:800;">Holy Eucharist</h1>
          Holy Eucharist, also known as Communion or the Lord's Supper, is a deeply significant sacrament observed in Christian faith. It is a solemn and sacred ritual in which believers partake of consecrated bread and wine, representing the Body and Blood of Jesus Christ. This sacrament offers spiritual nourishment, bringing participants into deeper communion with Christ and strengthening their faith.
        </div>
    </div>
