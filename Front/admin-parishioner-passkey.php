    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="#">Parishioner Passkey</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-data fade-up" style="outline: rgba(0, 0, 0, 0.1) solid 1px; border-radius:20px;">
        <div class="order">
            ...
            <table>
                <thead>
                    <tr>
                        <th style="padding-right:10px;">Profile Pic</th>
                        <th>Username</th>
                        <th>Email</th>
                        <th>Q1</th>
                        <th>A1</th> <!-- Added column for A1 -->
                    </tr>
                </thead>
                <tbody id="user-table-body">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr data-username='" . strtolower($row['username']) . "'>";
                            // Display Profile Image
                            echo "<td><img src='" . (!empty($row['userimg']) ? $row['userimg'] : 'path/to/placeholder-image.jpg') . "' alt='Profile Pic' width='50' height='50'></td>";
                            // Display Username
                            ...
                            // Display A1 (password) with the hover-to-reveal functionality
                            echo "<td><input type='password' value='" . htmlspecialchars($row['A1']) . "' class='password-input' readonly onmouseover='this.type=\"text\"' onmouseout='this.type=\"password\"'></td>";
                            echo "</tr>";
                        }
                    } else {
...
<script>
    // Search functionality for filtering the users by username
...
<style>
    /* Add some styling for password input field */
    .password-input {
        cursor: default;
        width: 100px;
        padding: 5px;
