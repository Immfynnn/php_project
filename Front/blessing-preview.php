...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <div class="input-b">
        ...
        <input type="text" id="r_type" name="r_type" value="<?php echo htmlspecialchars($reservation['r_type']); ?>" readonly>
    </div>  
    <div class="input-b">
        <label for="set_date">Schedule:</label>
        <input type="text" id="set_date" name="set_date" value="<?php echo htmlspecialchars($reservation['set_date']); ?>" readonly>
    </div>  
    <div class="input-b">
        <label for="time_slot">Time Slot:</label>
        <input type="text" id="time_slot" name="time_slot" value="<?php echo htmlspecialchars($reservation['time_slot']); ?>" readonly>
    </div>  
    <div class="input-b">
...
<?php if (!empty($reservation['amount'])): ?>
    <div class="input-b">
...
<?php if (!empty($reservation['payment_type'])): ?>
    <div class="input-b">
...
<a href="edit-reservation-blessing.php?s_id=<?php echo $reservation['s_id']; ?>">Edit Reservation</a>
...
document.getElementById('nextButton').addEventListener('click', function(event) {
    ...
    // Get the payment type value, ensure it handles null or undefined
    var paymentType = document.getElementById('payment_type') 
        ? document.getElementById('payment_type').value.trim() 
        : '';
    ...
    if (paymentType === 'Gcash (Scan / Send Money)') {
        ...
        // Redirect to my_reservation-details.php if payment type is null or blank
        window.location.href = 'my_reservation-details.php?s_id=' + s_id;
    }
});
</script>
