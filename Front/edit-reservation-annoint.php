...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        <div class="b-header">
            <h1>Annointing of the Sick</h1>
        </div>
        <form action="save-detail-annoint.php" method="POST" enctype="multipart/form-data">
        <div class="input-b">
...
<div id="payment_type_container"></div>
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="content-detail-serv1" style="background:url('css/img/annointing-pinoy.jpeg'); background-size:cover;">
