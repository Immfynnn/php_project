...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="blessing-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
        <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Blessing'; ?>" name="service_type" style="display:none;">
    </div>

    <div class="input-b">
        <label for="s_description">Full Name:</label>
        <input type="text" id="s_description" name="s_description" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required>
    </div>
    <div class="input-b">
        <label for="r_type">Type of Blessing:</label>
        <input type="text" id="r_type" name="r_type" value="<?php echo isset($r_type) ? htmlspecialchars($r_type) : ''; ?>" placeholder="House Blessing, Vehicle Blessing or Establishment Blessing" required>
    </div>

    <div class="input-b">
        <label for="set_date">Schedule:</label>
        <input type="date" id="set_date" name="set_date" value="<?php echo isset($set_date) ? htmlspecialchars($set_date) : ''; ?>" required>
    </div>
    ...
    <input type="number" id="ammount" name="amount" value="" placeholder="Any Amount" oninput="showPaymentType()" style="width:100%; text-align:left;">
</div>
