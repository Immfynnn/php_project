...
$sql = "
    ...
    WHERE reservation.s_status = 'Completed'
";
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="#">Success Reservation</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "
                                <tr data-service-id='" . htmlspecialchars($row['s_id']) . "' onclick='goToDetails(this)' style='cursor: pointer;'>
                                    ...
                                    <td><span style='color:blue; font-weight:bold;'>" . htmlspecialchars($row['s_status']) . "</span></td>
                                </tr>
                            ";
                        }
                    } else {
