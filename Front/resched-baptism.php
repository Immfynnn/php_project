...
document.addEventListener('DOMContentLoaded', function () {
   ...
   class="button-link">Back</a>

        </div>
        <form action="update-reservation-baptism.php" method="POST" enctype="multipart/form-data">
               <!-- Hidden input for s_id -->
    <input type="hidden" name="s_id" value="<?php echo htmlspecialchars($s_id); ?>">
            <div class="input-b">
                <input type="hidden" name="service_type" value="<?php echo htmlspecialchars($reservation['service_type']); ?>" style="opacity:.5;" readonly>
            </div>


            <div class="input-b">
                <label for="description">Description:</label>
                <input type="text" id="description" name="s_description" value="<?php echo htmlspecialchars($reservation['s_description']); ?>" style="opacity:.5;" readonly>
            </div>
                ...
                <label class="header-radio">
                    ...
                    <div class="right">
                        ...
                        <input type="radio" name="r_type" id="selector" class="regular" value="regular" 
                            <?php echo ($reservation['r_type'] === 'regular') ? 'checked' : ''; ?> disabled>
                    </div>
                </label>
            </div>
                ...
                <label class="header-radio"  style="padding:10px; border-radius:10px;">
                    ...
                    <div class="right" style="display:flex; flex-direction:row; justify-content:space-between; align-items:center;">
                        ...
                        <input type="radio" name="r_type" id="selector" class="special" value="special" 
                            <?php echo ($reservation['r_type'] === 'special') ? 'checked' : ''; ?> disabled>
                    </div>
                </label>
            </div>
            ...
            <div class="option1" tyle="opacity:.5;">
               <br>
               <hr>
               <div class="input-s" style="display:flex; flex-direction:row; justify-content:space-between; align-center:center; background:skyblue; padding:10px; border-radius:5px; margin-bottom:10px; margin-top:10px; ">
                   ...
                   <input type="number" name="per_head" id="per_head" value="<?php echo htmlspecialchars($reservation['per_head']); ?>" placeholder="Enter number" style="height:2.5rem; margin:auto;margin-left:180px;" disabled>
               </div>
           </div>
           <div class="option2" style="opacity:.5;">
               <br>
               <hr>
            ...
            <div class="input-b">
                ...
                <select name="time-slot" id="time-slot" style="opacity:.5;" >
                    <?php 
            ...
            <div class="input-b">
               ...
               <input type="file" id="validId" name="validId[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple style="opacity:.5;" readonly>
            ...
            <div class="input-b">
                ...
                <br>
                <input type="file" id="requirements" name="requirements[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple style="opacity:.5;" readonly>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Set opacity for both containers to 0.5
    regularContainer.style.opacity = '0.5';
    specialContainer.style.opacity = '0.5';
    ...
    function updateAmount() {
        ...
        const extraCount = regularRadio.checked
            ? parseInt(option1Input.value) || 0
            : parseInt(option2Input.value) || 0;
        const totalAmount = baseAmount + extraCount * additionalCharge;
        amountInput.value = `${totalAmount.toFixed(2)}`;
    }

    // Function to handle option display logic
