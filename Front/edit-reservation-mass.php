...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        <form action="save-detail-mass.php" method="POST" enctype="multipart/form-data">
        <div class="input-b">
    ...
    <div class="input-b">
        <label for="s_description">Description:</label>
        <p style="font-size:13px; margin-top:10px;">Inclusion: Mass in House And Mass in Church</p>
        <input type="text" id="s_description" name="s_description1" value="<?php echo htmlspecialchars($reservation['s_description1']); ?>" required>
    </div>  
