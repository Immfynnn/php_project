...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="burial-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
        <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Burial'; ?>" name="service_type" style="display:none;">
    </div>
    ...
    <div class="input-b">
        ...
        <input type="text" id="s_description" name="s_description" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required placeholder="Name of the Deceased and other details">
    </div>
    ...
    <div class="input-b">
                ...
                <input type="text" id="ammount" name="amount" value="<?php echo isset($amount) ? htmlspecialchars($amount) : '1500.00'; ?>" readonly>
            </div>
    <div class="input-b">
