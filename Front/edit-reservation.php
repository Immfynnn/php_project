...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <input type="hidden" id="service_type" name="service_type" value="<?php echo htmlspecialchars($reservation['service_type']); ?>" required>
        ...
        <div class="input-b">
            ...
            <select name="time-slot" id="time-slot">
                ...
                foreach ($time_slots as $slot) {
                    // Check if the slot matches the selected value (from the database)
                    $selected = (isset($reservation['time_slot']) && $reservation['time_slot'] === $slot) ? 'selected' : '';
        ...
        <div class="input-b">
            ...
            <input type="text" id="s_address" name="s_address" value="<?php echo htmlspecialchars($reservation['s_address']); ?>" required>
        </div>

        <div class="input-b">
            <label for="amount">Amount:</label>
            <input type="text" id="amount" name="amount" value="<?php echo htmlspecialchars($reservation['amount']); ?>" required>
        </div>
        ...
        <!-- Requirements upload field -->
        <div class="input-b">
            <label for="requirements">Requirements:</label>
            <p style="font-size:12px;">Death Certificate</p>
            <input type="file" id="requirements" name="requirements" accept="image/*,application/pdf,.docx,.doc" />
    ...
    <select name="payment_type" id="payment_type">
        <option value="Gcash (Scan / Send Money)" <?php echo ($reservation['payment_type'] == 'Gcash (Scan / Send Money)') ? 'selected' : ''; ?>>Gcash</option>
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="bg-content-bapt">  
          <h1 style="font-size:40px; text-transform:uppercase; font-weight:800;">Funeral / Burial</h1>
