...
<div class="header" style="margin-bottom:20px; display:flex; flex-direction:row; justify-content:space-between;">
    <h1>My Receipt</h1>
    <div>
    <a href="my_reservation.php"  style="margin-right:120px; padding:10px; padding-left:30px; padding-right:30px; background:#007BFF; border-radius:5px; color:#fff;">Done</a>
    </div>
</div>
        <div class="cont-receipt" id="receiptDiv">
            <div class="header">
            ...
            <div class="receipt-info">
                ...
                <input type="text" name="amount" id="amount" value="PHP <?php echo number_format($reservation['amount'], 2); ?>" style="cursor:default;" readonly>
                </div>
                <div class="div-inpt">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (receiptDiv) {
            receiptDiv.classList.add('fade-in'); // Add the fade-in class to trigger the effect
        } else {
