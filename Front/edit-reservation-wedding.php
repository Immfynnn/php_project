...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="save-detail-wedding.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
...
<div class="input-b">
    ...
    <input type="number" name="per_head" placeholder="Additional for Wedding Sponsor" value="<?php echo htmlspecialchars($reservation['per_head']); ?>" id="additional" min="0">
</div>
<div class="input-b">
