...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <div class="input-b">
        ...
        <p style="font-size:13px; margin-top:10px;">Schedule:</p>
        <input type="text" id="s_description" name="s_description1" value="<?php echo htmlspecialchars($reservation['r_type']); ?>" readonly>
    </div>  
...
<a href="edit-reservation-mass.php?s_id=<?php echo $reservation['s_id']; ?>">Edit Reservation</a>
