...
<head>
    ...
    <title>Dashboard | Total Payment</title>
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="#">Total Payment</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="order">
            ...
            <table>
                ...
                <tbody id="user-table-body">
                    <?php
                    // Include the PHP code to fetch and display paid records
                    include('fetch_paid_records.php'); // Assuming the PHP code is in this file
                    ?>
                </tbody>
            </table>
        </div>
