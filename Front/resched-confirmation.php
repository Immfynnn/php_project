...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="config-update-confrm.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="input-b">
        ...
        <input type="text" id="s_description" name="s_description" placeholder="Full Name" value="<?php echo htmlspecialchars($reservation['s_description']); ?>"   required placeholder="Name of the Deceased and other details" style="opacity:0.5; cursor:default;">
    </div>
    ...
    <div class="input-b">
        ...
        <input type="file" id="validId" name="validId[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple style="opacity:0.5; cursor:default;">
        <div>
            <label>Current Valid ID:</label>
            <a href="uploads/<?php echo htmlspecialchars($reservation['valid_id']); ?>" target="_blank" style="color:blue;"><?php echo htmlspecialchars($reservation['valid_id']); ?></a>
        </div>
    </div>
    ...
    <div class="input-b">
        ...
        <input type="file" id="requirements" name="requirements[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple style="opacity:0.5; cursor:default;">
        <div>
            <label>Current Requirements:</label>
            <a href="uploads/<?php echo htmlspecialchars($reservation['s_requirements']); ?>" target="_blank" style="color:blue;"><?php echo htmlspecialchars($reservation['s_requirements']); ?></a>
        </div>
    </div>

    <div class="input-b">
        <label for="amount">Type:</label>
        <input type="text" value="<?php echo htmlspecialchars($reservation['r_type']); ?>" class="input-conf-2" style="opacity:0.5; cursor:default;" readonly>
    </div>

    <div class="input-b">
        <label for="amount">Amount:</label>
        <input type="text" id="amount" name="amount" value="<?php echo htmlspecialchars($reservation['amount']); ?>" style="width:100%; opacity:.5;" readonly>
    </div>
    ...
    <button type="submit" name="update_reservation">Next</button>
</form>
