...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        <form action="save-detail-holy-e.php" method="POST" enctype="multipart/form-data">
        <div class="input-b">
    <input type="hidden" id="service_type" name="service_type" value="<?php echo htmlspecialchars($reservation['service_type']); ?>" required>
        ...
        <p style="font-size:13px; margin-top:10px;">Name:</p>
    ...
    <div class="input-b">
        ...
        <input type="number" id="s_description" name="s_description1" value="<?php echo htmlspecialchars($reservation['s_description1']); ?>" required placeholder="" style="width:100%;">
    </div>
    <div class="input-b">
        <label for="set_date">Schedule:</label>
        <input type="date" id="s_description" name="set_date" value="<?php echo htmlspecialchars($reservation['set_date']); ?>" required>
    </div>  

    <div class="input-b">
    <label for="time_slot">Time Slot:</label>
    <select name="time_slot" id="time-slot"> <!-- Change name to "time_slot" -->
        <?php
        $time_slots = [
            "6:00AM (Morning)",
            "7:00AM (Morning)",
...
<div class="input-b">
        <label for="s_description">Addresss:</label>
        <input type="text" id="s_description" name="s_address" value="<?php echo htmlspecialchars($reservation['s_address']); ?>" required>
    </div>  
...
<div id="payment_type_container"></div>
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="bg-content-bapt">  
          <h1 style="font-size:40px; text-transform:uppercase; font-weight:800;">Annointing of the Sick</h1>
          Anointing of the Sick is a sacrament offered to individuals who are seriously ill or elderly, bringing comfort, spiritual strength, and healing. During this sacrament, the individual is anointed and prayed over, with the belief that it provides spiritual healing and helps the person grow closer to God, especially in times of suffering.
        </div>
    </div>
