...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <div class="input-b">
        ...
        <input type="text" id="schedule" name="schedule" value="<?php echo htmlspecialchars($reservation['r_type']); ?>" readonly>
    </div>
...
<a href="edit-reservation-cnfrm.php?s_id=<?php echo $reservation['s_id']; ?>">Edit Reservation</a>
