...
if ($s_id) {
    ...
    <form action="payment-config.php" method="POST" enctype="multipart/form-data">
    <!-- Other form fields -->
...
<script>
    ...
    document.querySelector("form").addEventListener("submit", function (event) {
        ...
        }, 0); // Delay is optional; set to 0 for immediate submission
    });
    ...
    function previewImage(event) {
        ...
        if (file) {
            ...
            imgPreview.style.display = 'none'; // Hide the preview if no valid file
            imgPreview.src = ""; // Clear any existing preview
        }
    }
</script>
