...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO reservation (uid, service_type, s_description, set_date, valid_id, s_requirements, r_type, amount, payment_type) VALUES (?,?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    $stmt->bind_param("issssssss", $user_id, $service_type, $s_description, $schedule, $valid_id_json, $requirements_json,$r_type, $amount, $payment_type);
    ...
    if ($stmt->execute()) {
        ...
        header("Location: confirmation-prev.php");
        exit();
    } else {
