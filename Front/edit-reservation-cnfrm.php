...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="save-detail-cnfrm.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
    ...
    <div class="radio-cnt-1" id="regularContainer" style="background:skyblue; transition: opacity 0.3s;">
        <label class="header-radio">
            <h4>Wedding Requirements</h4>
            <div class="right">
                <h5>PHP500.00</h5>
                <input type="radio" name="r_type" id="regularRadio" class="regular" value="Wedding Requirements" required>
