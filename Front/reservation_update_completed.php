...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['service_id'])) {
    ...
    // Prepare the update query to set status to 'Completed'
    $sqlUpdate = "UPDATE reservation SET s_status = 'Completed' WHERE s_id = ?";
    ...
    if ($stmtUpdate->execute()) {
        ...
        if ($reservationDetails) {
            ...
            // Set the notification message for "Completed" with "Thanks for your reservation"
            $notificationMessage = "Your reservation for {$service_type} has been Completed. Thanks for your reservation!";
