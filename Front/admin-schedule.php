...
<div class="schedule-cont">
                ...
                <div class="cardt rounded-0 shadow">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            <form action="schedule_save.php" method="post" id="schedule-form">
                                <input type="hidden" name="id" value="">
                                <div class="form-group mb-2">
                                    <label for="title" class="control-label">Title</label><br>
                                    <input type="text" class="form-control form-control-sm rounded-0" name="title" id="title" style="width:95%;" required>
                                </div>
                                <div class="form-group mb-2">
                                    <label for="description" class="control-label">Description</label><br>
                                    <textarea rows="3" cols="32" class="form-control form-control-sm rounded-0" name="description" id="description" required></textarea>
                                </div>
                                <div class="form-group mb-2">
 ...
 <!-- First Overlay for success message (schedule saved) -->
 <div class="overlay06" id="overlay06" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 9999; justify-content: center; align-items: center; text-align: center; color: white; font-size: 20px;">
        <div class="overlay-content">
            <p>Schedule Successfully Saved!</p>
        </div>
    </div>

    <!-- Second Overlay for delete success message -->
    <div class="overlay07" id="overlay07" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.5); z-index: 9999; justify-content: center; align-items: center; text-align: center; color: white; font-size: 20px;">
        <div class="overlay-content">
            <p>Schedule Successfully Deleted!</p>
        </div>
    </div>

    <script>
        // Trigger the overlay display if status=deleted is found in the URL
        window.onload = function() {
            const urlParams = new URLSearchParams(window.location.search);
            const status = urlParams.get('status');

            if (status === 'deleted') {
                const overlay = document.getElementById('overlay07');
                overlay.style.display = 'flex'; // Show overlay for deletion
                ...
                const overlay = document.getElementById('overlay06');
                overlay.style.display = 'flex'; // Show overlay for save
