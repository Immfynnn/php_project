...
border-radius:5px; color:#fff;">Back</a>
    ...
    <div class="input-b">
        ...
        <input type="text" id="s_description" name="s_description" placeholder="Full Name" value="<?php echo htmlspecialchars($reservation['s_description']); ?>" required placeholder="Name of the Deceased and other details">
    </div>
    ...
    <div class="input-b">
        ...
        <input type="text" value="<?php echo htmlspecialchars($reservation['r_type']); ?>" class="input-conf-2" readonly>
    </div>
