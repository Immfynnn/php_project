...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <div class="input-b">
        ...
        <input type="text" id="time-slot" name="time-slot" value="<?php echo htmlspecialchars($reservation['per_head']); ?>" readonly>
    </div>
    <div class="div-row-2">
    <div class="input-b">
    ...
    <a href="my_reservation-details.php?s_id=<?php echo $s_id; ?>">Done</a>
        <a href="my_reservation-update-baptism.php?s_id=<?php echo $reservation['s_id']; ?>">Edit Reservation</a>
