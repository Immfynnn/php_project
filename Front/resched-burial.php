...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        <form action="my_reservation-update2.php" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" name="s_id" value="<?php echo htmlspecialchars($s_id); ?>">
            ...
            <div class="input-b">
                ...
                <input type="text" id="s_description" name="s_description" value="<?php echo htmlspecialchars($reservation['s_description']); ?>" style="opacity:0.5; cursor:default;" required>
            </div>
            ...
            <div class="input-b">
                ...
                <select name="time-slot" id="time-slot" style="opacity:0.5; cursor:default;"> 
                    <?php
                    ...
                    // Loop through time slots and add them as options
                    foreach ($time_slots as $slot) {
                        $selected = ($reservation['time_slot'] === $slot) ? 'selected' : ''; // Check if this is the current selected slot
            ...
            <div class="input-b">
                ...
                <input type="text" id="s_address" name="s_address" value="<?php echo htmlspecialchars($reservation['s_address']); ?>" style="opacity:0.5; cursor:default;" required>
            </div>

            <!-- Amount input -->
            <div class="input-b">
                <label for="amount">Amount:</label>
                <input type="text" id="amount" name="amount" value="<?php echo htmlspecialchars($reservation['amount']); ?>" style="opacity:0.5; cursor:default;" readonly>
            </div>

            <!-- Valid ID upload input -->
            <div class="input-b">
                <label for="valid_id">Reserver's Valid ID:</label>
                <p style="font-size:12px;">Note: valid ID is required</p>
                <input type="file" id="valid_id" name="valid_id" style="opacity:0.5; cursor:default;" accept="image/*,application/pdf,.docx,.doc" />
                <?php if ($reservation['valid_id']): ?>
                    <div>
                        <label>Current Valid ID:</label>
                        <p><?php echo htmlspecialchars($reservation['valid_id']); ?></p>
                    </div>
                <?php endif; ?>
            </div>

            <!-- Requirements upload input -->
            <div class="input-b">
                <label for="requirements">Requirements:</label>
                <p style="font-size:12px;">Death Certificate</p>
                <input type="file" id="requirements" name="requirements" style="opacity:0.5; cursor:default;" accept="image/*,application/pdf,.docx,.doc" />
                <?php if ($reservation['s_requirements']): ?>
                    <div>
                        <label>Current Requirements:</label>
                        <p><?php echo htmlspecialchars($reservation['s_requirements']); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="button-container">
                ...
                <button type="submit" name="update_reservation" class="a-btn">Submit</button>
            </div>
        </form>
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="content-detail-serv1">
        <div class="bg-content-bapt">  
          <h1 style="font-size:40px; text-transform:uppercase; font-weight:800;">Burial</h1>
          Burial is a solemn ceremony marking the final resting place of a deceased individual. It holds deep cultural, religious, and personal significance, reflecting beliefs about the afterlife. The ritual often includes prayers honoring the life and memory of the departed. It signifies the belief in the sanctity of the body and the soul’s journey toward reunion with God in the afterlife.
        </div>
    </div>
