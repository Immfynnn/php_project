        ...
        <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                        <li>
                            <a class="active" href="#">Approved Reservation</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="table-data fade-up">
                <div class="order">
                    ...
                    <table>
                        ...
                        <tbody>
                           <?php
                               // Query to fetch reservation data from the reservation table
                              $sqlReservations = "SELECT reservation.*, users.userimg, users.username, payment.p_status 
                              FROM reservation
                              JOIN users ON reservation.uid = users.uid
                              LEFT JOIN payment ON reservation.s_id = payment.s_id
                              WHERE reservation.s_status IN ('Approved')";
                ...
                <td><span class="status <?php echo strtolower($reservationRow['p_status']); ?>"><?php echo htmlspecialchars($reservationRow['p_status']); ?></span></td>
                ...
                <td>
                   <?php if ($reservationRow['s_status'] == 'Approved') { ?>
                   ...
                   <?php } ?>
                   <?php if ($reservationRow['s_status'] == 'Ongoing') { ?>
