...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('click', function (event) {
        ...
        <form action="update-detail-blessing.php" method="POST" enctype="multipart/form-data">
        <div class="input-b">
    ...
    <input type="hidden" id="service_type" name="service_type" value="<?php echo htmlspecialchars($reservation['service_type']); ?>" required>
        ...
        <input type="text" id="s_description" name="s_description" value="<?php echo htmlspecialchars($reservation['s_description']); ?>" style="opacity:0.5;" required>
    </div>  
    <div class="input-b">
        <label for="r_type">Type of Blessing:</label>
        <input type="text" id="r_type" name="r_type" value="<?php echo htmlspecialchars($reservation['r_type']); ?>" style="opacity:0.5;" required>
    </div>  
    <div class="input-b">
    ...
    <select name="time_slot" id="time-slot" style="opacity:0.5;">
        <?php
...
<div class="input-b">
       ...
       <input type="text" name="s_address" id="s_address"  value="<?php echo htmlspecialchars($reservation["s_address"]); ?>" style="opacity:0.5;"  required>
    </div>
...
<div class="input-b">
    ...
    <input type="file" id="validId" name="validId[]" style="opacity:0.5;" accept="image/*,application/pdf,.docx,.doc" multiple />
