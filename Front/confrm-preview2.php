...
<a href="update-confirmation.php?s_id=<?php echo $reservation['s_id']; ?>">Edit Reservation</a>
<?php if (strtolower($reservation['payment_type']) !== 'gcash (scan / send money)' && strtolower($reservation['payment_type']) !== 'over the counter' && strtolower($reservation['payment_type']) !== '') : ?>
