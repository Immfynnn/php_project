...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="confirmation-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
        <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Confirmation'; ?>" name="service_type" style="display:none;">
    </div>

    <div class="input-b">
        <label for="s_description">Name:</label>
        <input type="text" id="s_description" name="s_description" placeholder="Full Name" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required placeholder="Name of the Deceased and other details">
    </div>
    ...
    <div class="input-b">
    <p style="font-size:15px; font-weight:bold; margin-bottom:10px;">Select the 2 option</p>

</div>

<div class="radio-cnt-1" id="regularContainer" style="background:lightgreen; box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:20px; transition: opacity 0.3s;">
    <label class="header-radio">
        <h4>Wedding Requirement</h4>
        <div class="right">
            <h5>PHP 500.00</h5>    
            <input type="radio" name="r_type" id="regularRadio" class="regular" value="Wedding Requirement" required>
        </div>
    </label>
</div>
...
<div class="radio-cnt-1" id="specialContainer" style="background:url(css/img/header-background1.png); box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:20px; transition: opacity 0.3s;">
    <label class="header-radio">
        <h4>Yearly Requirement</h4>
        <div class="right">
            <h5>PHP 300.00</h5>    
            <input type="radio" name="r_type" id="specialRadio" class="special" value="Yearly Requirement" required>
        </div>
    </label>
</div>

<div class="regular-text" id="regularText" style="display:none;"> 
</div>
<div class="regular-text" id="specialText" style="padding:10px; text-align:center; background:url(css/img/header-background1.png); background-size:cover; background-position:center; box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:15px; border-radius:20px 0 20px 0; color:#000; display:none;"> 
    <h3>Note: Schedule Subject to Announcement</h3>
</div>
...
<div class="input-b">
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="content-detail-serv1" style="background:url('css/img/confirmation-1.jpg'); background-size:cover; background-position:center;">
        <div class="bg-content-bapt">  
          <h1 style="font-size:40px; text-transform:uppercase; font-weight:800;">Confirmation</h1>
          Confirmation is a sacred and meaningful religious ceremony observed in many Christian denominations, symbolizing the affirming and strengthening of one's faith commitment. Typically occurring during adolescence or early adulthood, confirmation is often viewed as a rite of passage within the church community.
        </div>
    </div>
