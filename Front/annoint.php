...
border-radius:5px; color:#fff;">Back</a>
        ...
        <form action="annoint-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
    <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Annointing of the Sick'; ?>" name="service_type" style="display:none;">            
    </div>

    <div class="input-b">
        <label for="s_description">Description:</label>
        <input type="text" id="s_description" name="s_description" value="<?php echo isset($description) ? htmlspecialchars($description) : ''; ?>" required placeholder="Full Name">
    </div>

    <div class="input-b">
        <label for="set_date">Schedule:</label>
        <input type="date" id="set_date" name="set_date" value="<?php echo isset($schedule) ? htmlspecialchars($schedule) : ''; ?>" required>
    </div>
