...
border-radius:5px; color:#fff;">Back</a>
        ...
        padding:15px; border-radius:6px; cursor:default; font-family:san-serif;">
            ...
            <br>
            <p><b>Noted:</b> Seminar(every 3rd Sunday) <br> <b>Note:</b> All requirement Shall be fullfilled 3rd days before</p>
        </div>
        <form action="wedding-config.php" method="POST" enctype="multipart/form-data">
    <div class="input-b">
        <input type="text" value="<?php echo isset($service_type) ? htmlspecialchars($service_type) : 'Wedding'; ?>" name="service_type" style="display:none;">
    </div>
    <div class="input-b"> 
        <label for="schedule">Groom:</label>
        <input type="text" name="s_description" placeholder="Full Name" id="">        
    </div>
    <div class="input-b"> 
        <label for="schedule">Bride:</label>
        <input type="text" name="s_description1" placeholder="Full Name" id="">        
    </div>
    <div class="radio-cnt-1" id="regularContainer" style="background:#90EE90; box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:15px; transition: opacity 0.3s;">
...
<div class="radio-cnt-1" id="specialContainer" style="background:url(css/img/header-background1.png); box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:20px; transition: opacity 0.3s;">
    <label class="header-radio">
        <h4>SPECIAL</h4>
        <div class="right">
            <h5>PHP5,000.00</h5>    
...
<div class="regular-text" id="regularText" style="padding:10px; text-align:center; background:lightgreen; box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:15px; border-radius:20px 0 20px 0; color:#000; display:none;"> 
    <h3>Regular - Every Thursday</h3>
</div>
<div class="regular-text" id="specialText" style="padding:10px; text-align:center; background:url(css/img/header-background1.png); background-size:cover; background-position:center; box-shadow:0 8px 5px rgba(0,0,0,.5); margin-bottom:15px; border-radius:20px 0 20px 0; color:#000; display:none;"> 
    <h3>Special - Not Available Sunday</h3>
</div>
    ...
    <div class="input-b">
<!--if regular every thursday-->
<!--if special anytime except sunday-->
        <label for="set_date">Schedule:</label>
        <input type="date" id="schedule" name="set_date" value="<?php echo isset($schedule) ? htmlspecialchars($schedule) : ''; ?>" required>
    </div>
    ...
    <div class="input-b">
        ...
        <select name="time-slot" id="time-slot">
            ...
            foreach ($time_slots as $slot) {
                // Check if the slot matches the selected value (if any)
                $selected = (isset($time_slot) && $time_slot === $slot) ? 'selected' : '';
    ...
    <div class="input-b">
        ...
        <input type="file" id="requirements1" name="requirements1[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple required>
    </div>
    <div class="input-b">
        <label for="requirements">Requirements:</label>
        <p style="font-size:12px;">Baptismal Male and Female: </p>
        <input type="file" id="requirements2" name="requirements2[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple required>
    </div>
    <div class="input-b">
        <label for="requirements">Requirements:</label>
        <p style="font-size:12px;">Confirmation Male and Female: </p>
        <input type="file" id="requirements3" name="requirements3[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple required>
    </div>
    <div class="input-b">
        <label for="requirements">Requirements:</label>
        <p style="font-size:12px;">Marriage License Filed: </p>
        <input type="file" id="requirements4" name="requirements4[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx" multiple required>
    </div>
    <div class="input-b">
    <label for="requirements">Perhead: PHP 100.00</label>
    <p style="font-size:12px;">Additional for Wedding Sponsor </p>
    <input type="number" name="per_head" id="additional" min="0" style="width:100%;">
</div>
<div class="input-b">
    ...
    <div class="container py-5" id="page-container">
        ...
        <div class="content-det ail-serv1" style="background:url(css/img/pinoy-wedding.jpg); margin-top:30px; border-radius:10px; background-position:center; background-size:cover; background-repeat:no-repeat;">
